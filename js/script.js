...
if (typeof translations === "undefined") return;
    ...
    if (currentLanguage === "ar") {
        ...
        setText("servicesTitle", translations.en.servicesTitle);
        setText("service1", translations.en.service1);
        setText("service2", translations.en.service2);
        setText("service3", translations.en.service3);
        setText("service4", translations.en.service4);
        ...
        setText("servicesTitle", translations.ar.servicesTitle);
        setText("service1", translations.ar.service1);
        setText("service2", translations.ar.service2);
        setText("service3", translations.ar.service3);
        setText("service4", translations.ar.service4);
